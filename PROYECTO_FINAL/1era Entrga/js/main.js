...
switch(entrada3){
    case "SI":
        ...
        alert("El desarrollo de " + entrada4.toString() + " tiene un costo de " + costoImplementacion.toString() + " AR$, y fue agregada a su presupuesto")
